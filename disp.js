...
function dispShowPendingPopup() {
  ...
  popup.innerHTML =
    ...
    "max-width:480px;padding:20px 18px 36px;box-shadow:0 -4px 24px rgba(0,0,0,.2);" +
    ...
    bodyHTML +
    "<div style='font-size:12px;color:#7a5c45;margin-top:8px'>Il laboratorio è stato avvisato. Puoi continuare a compilare l'ordine ma non salvarlo finché non arriva la risposta.</div>" +
    "</div>";

  // Tocco sullo sfondo scuro = solo nascondi (non inviare nuove richieste)
